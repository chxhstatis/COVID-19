...
ElbowPlot(T_cell)
#harmony矫正
T_cell = T_cell %>% RunHarmony(group.by.vars="order", plot_convergence = TRUE)
...
T_cell <- T_cell %>%
  ...
  identity()
#降维可视化
p1 <- DimPlot(T_cell, reduction = "tsne", group.by = "order",
              pt.size = 0.5)
p2 <- DimPlot(T_cell, reduction = "tsne", pt.size = 0.5, label=T)
p3 <- DimPlot(T_cell, reduction = "umap", group.by = "order",
              pt.size = 0.5)
...
VlnPlot(T_cell, features=c("SLC4A10",
                           "ISG15","STAT1","LY6E","OAS1",
                           "FCER1G","NAMPT","S100A8","FCGR3B",
                           "TRDV2","TRGV9",
                           "CD8A","CD4",
                           "SELL","CCR7","TCF7",
        ...
        pt.size=0)
FeaturePlot(T_cell, features=c("SLC4A10",
                               "ISG15","STAT1","LY6E","OAS1",
                               "FCER1G","NAMPT","S100A8","FCGR3B",
                               "TRDV2","TRGV9",
                               "CD8A","CD4",
                               ...
                               "CTLA4","CCR4","CD69","IL7R","LTB"),
            label=T,order=T)
DotPlot(T_cell, features=c("SLC4A10",
                           "ISG15","STAT1","LY6E","OAS1",
                           "FCER1G","NAMPT","S100A8","FCGR3B",
                           "TRDV2","TRGV9",
                           "CD8A","CD4",
                           ...
                           "IL2RA","FOXP3",
                           "CTLA4","CCR4","CD69","IL7R","LTB"))
new.cluster.ids <- c("CD4Tn","CXCR4 CD8Tem","CD4Teff","Resting CD4T","activated CD4T",
                     "ISG CD4T","GZMK CD8Tem","ISG CD8T","CD4Tcm","CD8Tn",           
                     "CD4Treg","MAIT/gdT","mixed Tcells","Resting CD4T","CD8Tex",
                     "innate-like Tcells")
